                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($rating->status == 0)
                                    <a href="javascript:void(0)" onclick="ChangeStatus('{{ $rating->id }}')" class="btn btn-success">Approve</a>
                                    @else
                                    <a href="javascript:void(0)" onclick="ChangeStatus('{{ $rating->id }}')" class="btn btn-danger">Decline</a>
                                    @endif
                                </td>

                                <td>
                                <a href="{{ route('Show-Rating',$rating->id) }}" class="text-success w-4 h-4 mr-1">
...
function deleteRating(id) {
    var url = '{{route("Delete-Rating","ID")}}';
