            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                placeholder="Title" value='{{ $accessorie->title }}'>
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" readonly name="slug" id="slug" class="form-control"
                                                placeholder="slug"  value='{{ $accessorie->slug }}'>
                                            <p class="error"></p>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="description">Description</label>
                                                ...
                                                class="summernote" placeholder="Description">{{ $accessorie->description }}</textarea>
                                            <p class="error"></p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <input type="hidden" name="img_array" value="{{$accessorie->id}}">
                                <img src="{{asset('uploads/accessorie/thumb/'.$accessorie->img)}}" class="card-img-top"
                                    alt="...">
                            </div>
                        </div>
                        @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="price" id="price" class="form-control"
                                                placeholder="Price"  value='{{ $accessorie->price }}'>
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="qty" id="qty" class="form-control"
                                                placeholder="qty"  value='{{ $accessorie->qty }}'>
                                            <p class="error"></p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        <option value="1" {{ ($accessorie->status == 1) ? 'selected' : '' }}>Active</option>
                                        <option value="0"  {{ ($accessorie->status == 0) ? 'selected' : '' }}>Block</option>
                                    </select>
                                    <p class="error"></p>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="is_featured" id="is_featured" class="form-control">
                                        <option value="No"  {{ ($accessorie->is_featured == 'No') ? 'selected' : '' }}>No</option>
                                        <option value="Yes"  {{ ($accessorie->is_featured == 'Yes') ? 'selected' : '' }}>Yes</option>
                                    </select>
                                    <p class="error"></p>
                                </div>
                            </div>
...
$('#Accessoriesform').submit(function(event) {
    ...
    $.ajax({
        url: '{{route("Update-Accessorie",$accessorie->id)}}',
        type: 'post',
