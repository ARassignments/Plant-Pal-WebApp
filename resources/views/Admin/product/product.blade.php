                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th width="80"></th>
                                    <th>
                                        <a href="{{ route('product', ['keyword' => request()->keyword, 'sort_by' => 'title', 'sort_order' => request('sort_order') === 'desc' ? 'asc' : 'desc']) }}"
                                    ...
                                    <th>
                                        <a href="{{ route('product', ['keyword' => request()->keyword, 'sort_by' => 'price', 'sort_order' => request('sort_order') === 'desc' ? 'asc' : 'desc']) }}"
                                            class="text-decoration-none text-dark">
                                            Price
