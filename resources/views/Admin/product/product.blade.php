    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="mt-3">
        <div class="btn-group">
            <a href="{{ route('product', ['keyword' => request()->keyword, 'sort_by' => 'title', 'sort_order' => request('sort_order') === 'desc' ? 'asc' : 'desc']) }}" class="btn btn-link">
                Title {{ request('sort_by') === 'title' ? (request('sort_order') === 'desc' ? '▲' : '▼') : '' }}
            </a>
            <a href="{{ route('product', ['keyword' => request()->keyword, 'sort_by' => 'price', 'sort_order' => request('sort_order') === 'desc' ? 'asc' : 'desc']) }}" class="btn btn-link">
